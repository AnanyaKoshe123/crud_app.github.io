...
const Edit = () => {
    ...
    const handleUpdate=(e)=>{
        e.preventDefault();
        axios.put(`https://65c4a175dae2304e92e2f916.mockapi.io/crud/${id}`,{e_name:name,e_age:age,e_mail:email})
        .then(()=>{
            navigate("/");
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form  onSubmit={handleUpdate}>
                  ...
                  <h5 class="fw-normal mb-3 pb-3" styles="letter-spacing: 1px;">Edit your data....</h5>

                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example17" class="form-control form-control-lg" value={name} onChange={(e)=>setName(e.target.value)} />
                    <label class="form-label" for="form2Example17">Name</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="number" id="form2Example27" value={age} class="form-control form-control-lg" onChange={(e)=>setAge(e.target.value)} />
                    <label class="form-label" for="form2Example27">Age</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example27" value={email}    class="form-control form-control-lg" onChange={(e)=>setEmail(e.target.value)} />
